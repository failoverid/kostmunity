...
const AddLostItemModal = ({ visible, onClose }: AddModalProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await reportLostItem(nama, "Admin", imageUri || undefined, kontak, lokasi, isFound);
        ...
        <View style={modalStyles.container}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={modalStyles.formGroup}>
              <TextInput style={modalStyles.input} placeholder="Nama Barang" placeholderTextColor="#A0A090" value={nama} onChangeText={setNama} />
              <TextInput style={modalStyles.input} placeholder="Status (Kehilangan / Ditemukan)" placeholderTextColor="#A0A090" value={status} onChangeText={setStatus} />
              <TextInput style={modalStyles.input} placeholder="Lokasi Terakhir" placeholderTextColor="#A0A090" value={lokasi} onChangeText={setLokasi} />
              <TextInput style={modalStyles.input} placeholder="Info Kontak" placeholderTextColor="#A0A090" value={kontak} onChangeText={setKontak} />
...
// ==========================================
// 3. COMPONENT: LIST ITEM CARD (STYLE FEEDBACK)
// ==========================================
  ...
  return (
    <View style={styles.card}>
      <View style={styles.cardInner}>
        ...
        {/* Kolom Kiri: Gambar (Mirip Feedback) */}
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={{ gap: 4, marginBottom: 8 }}>
             ...
             {/* Menampilkan Status sebagai teks kecil atau Info Kontak */}
             <Text style={styles.contactText}>
                {item.description ? `Kontak: ${item.description}` : "Tidak ada info kontak"}
             </Text>
          </View>

          {/* Tombol Aksi (Mirip Feedback) */}
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {/* List Container (Gaya Feedback: Vertical List) */}
...
// ==========================================
// 5. STYLES (MATCHING FEEDBACK PAGE)
// ==========================================

const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: "#525252" }, // Background Abu Gelap
  ...
  // CARD STYLES (Sama dengan FeedbackCard)
  card: {
    backgroundColor: "#d4d4d4", // Warna abu terang
    borderRadius: 12,
    overflow: "hidden",
    elevation: 2,
  },
...
// STYLES MODAL (Tetap Cream Theme agar estetik)
